...
RapidApp ships with the script L<rapidapp.pl> which you can used to create a new
...
create a DBIC model and schema for existing database:
...
L<rapidapp.pl>, L<catalyst.pl|catalyst>, L<RapidApp::Helper>, L<Catalyst::Helper>
