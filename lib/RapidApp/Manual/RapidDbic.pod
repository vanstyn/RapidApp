...
L<Plack>-compatable app with L<Plack::App::RapidApp::rDbic>. There is also the command-line wrapper 
...
exmaples in L<RapidApp::Manual::Bootstrap> mainly cover RapidDbic, which show how to bootstrap a new 
