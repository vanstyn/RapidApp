...
install it. RapidApp should work with any version, but at the time of this writing,
perl 5.16.x seems to have the fewest issues.
...
=head2 Copy-Paste Recap

To recap the series of commands to install perlbrew+RapidApp on most Unix-based systems, 
if you are feeling brave, you can copy and paste the following into your shell to do it
all in one swoop:
...
Assuming everything worked, you should see this as the last line of the output:
