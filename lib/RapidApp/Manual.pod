...
RapidApp::Manual - Index of the Manual
 
=head1 DESCRIPTION
 
This is the L<RapidApp> users manual, which is still in progress. RapidApp is 
a new open-source web application framework based on L<Catalyst>, ExtJS, 
L<Template::Toolkit> and L<DBIx::Class> for quickly creating interactive, 
data-rich webapps.
